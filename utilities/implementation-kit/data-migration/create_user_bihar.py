...
iphard = '{"mobileNumber":"9980770587","message":"प्रिय  Mani, आपको पंजाब के mGramSeva एप्लिकेशन में आमंत्रित किया गया है। कृपया https://uat.peyjalbihar.org/mgramseva/login का उपयोग करके लॉगिन करें। उपयोगकर्ता नाम: 9980770587 पासवर्ड: eGov@123. EGOVS","category":"TRANSACTION","expiryTime":null}'
...
def createUser(sheet, rowIndex, accesstoken, file):
    ...
    cityTenantId = 'br.' + cityTenantId.lower()
    ...
    if (userSearchResponse == None or len(userSearchResponse) == 0):
        ...
        myroles = []
        for role in userSearchResponse[0]['roles']:
        	print("role:" + str(role), end="\n")
        print("roles \n"+str(userSearchResponse[0]['roles']), end="\n")
